...
include("bug.class.php");
		...
		$tituloBUG 		=  _("Captura de Requisitos - Bugs");
				
		$tTituloBUG 	= _("Titulo");
		$tCuerpoBUG 	= _("Descripción del problema:");		
		$funcBUG 		= "EnviarBug";
		$prepopuladoBUG	= _("Escriba aquí 1) como reproducir el error. 2) Que esperaba. 3) Que ocurrio");			
   ...
   <spacer flex="1"/>	 		 	
       ...
       <tabpanel>	 	
		<groupbox flex="1">
			...
			<description><?php  echo _("Categoria"); ?></description>
			...
			<description><?php echo _("Que ocurrio"); ?></description>
...
var po_sugerenciarecibida = "<?php echo _("Sugerencia recibida") ?>";
var po_incidenciaanotada = "<?php echo _("Incidencia anotada") ?>";
var po_notaenviada =  "<?php echo _("Nota enviada") ?>";
var po_servidorocupado = "<?php echo _("El servidor esta ocupado, por favor intentelo mas tarde.") ?>";
...
function EnviarSugerencia(){
	...
	var xrequest = new XMLHttpRequest();
	var data = "titulo="+encodeURIComponent(titulo)+"&cuerpo=" + encodeURIComponent(cuerpo);       	
