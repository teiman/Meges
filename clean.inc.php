...
function Clean8859toUTF8($str){
	//Necesita soporte del servidor que no es estandar.	
...
function CleanParaXul($texto){
	...
	//$texto = htmlspecialchars($utf8_string, ENT_COMPAT, 'UTF-8');
	//$texto = str_replace("'", '&#039;', $texto);*/
...
function CleanFechaES($fecha){
	...
	if ($fecha == "DD/MM/AAAA" or $fecha == "DD-MM-AAAA")
		return "";
...
function Clean($text){
	return $text;//Funcion inocua, no hace nada	
}
