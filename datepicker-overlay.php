...
echo str_replace("@","?","<@xml-stylesheet href='skin/datepicker.css' type='text/css'@>");
...
<vbox id="oe-date-picker-overlay-box" >
   ...
   <!-- Year controls -->
      <hbox id="oe-date-picker-year-controls-box"  >
         ...
         <box flex="1">   
            <image src="skin/arrow.gif" onclick="oeDatePicker.previousYearCommand()"/>
         </box>
                
         <label id="oe-date-picker-year-title-text" value="" />
        
         <box flex="1" id="oe-date-picker-year-next-button-box" >
            <image src="skin/arrow2.gif" onclick="oeDatePicker.nextYearCommand()"/> 
         </box>  
